...
public class TakePhotoUtils {
    ...
    public static List<String> saveBitmapFileList(List<String> path, int width, int height) {
        ...
        for (int i = 0; i < path.size(); i++) {
            ...
            String save_path = Environment.getExternalStorageDirectory().getPath() + Constants.ERROR_PATH + "abc" + i + ".jpg";
            paths.add(save_path);
    ...
    public static void setDownloadPath() {
        String save_path_parent = Environment.getExternalStorageDirectory().getPath() + Constants.ERROR_PATH;
