...
import org.srr.dev.view.xrecyclerview.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView(Context context ){
        ...
        layoutParams.setMargins( (int)getResources().getDimension(R.dimen.xrecyclerview_textmargin),0,0,0 );
    ...
    public void  setState(int state) {
        switch(state) {
            case STATE_LOADING:
                ...
                mText.setText(mContext.getText(R.string.xrecyclerview_loading));
