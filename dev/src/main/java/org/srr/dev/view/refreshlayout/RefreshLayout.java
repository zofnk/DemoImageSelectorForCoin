...
public class RefreshLayout extends ViewGroup {
    ...
    private RefreshCircleImageView mCircleView;
    ...
    private void createProgressView() {
        mCircleView = new RefreshCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
                ...
                if (mIsFooterBeingDragged) {
                    setTriggerPercentage(
                            mAccelerateInterpolator.getInterpolation(
                                    clamp(-yDiff, 0, mFooterDistanceToTriggerSync) / mFooterDistanceToTriggerSync));
                    mLastMotionY = y;
                }
                break;
