...
public class ExStaggeredGridLayoutManager extends StaggeredGridLayoutManager {
    ...
    private Drawable itemdivier;

    public ExStaggeredGridLayoutManager(int spanCount, int orientation) {
        super(spanCount, orientation);
    }

    public ExStaggeredGridLayoutManager(int spanCount, int orientation, Drawable itemdivier) {
        super(spanCount, orientation);
        this.itemdivier = itemdivier;
    }
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        if (getOrientation() == VERTICAL) {
            int itemdivierhight = itemdivier.getIntrinsicHeight();
        }
        // 设置测量尺寸
