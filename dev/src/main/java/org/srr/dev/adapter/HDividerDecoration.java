 ...
 */
public class HDividerDecoration extends FlexibleDividerDecoration {

    private MarginProvider mMarginProvider;

    protected HDividerDecoration(Builder builder) {
        super(builder);
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public HDividerDecoration build() {
            checkBuilderParams();
            return new HDividerDecoration(this);
        }
    }
}