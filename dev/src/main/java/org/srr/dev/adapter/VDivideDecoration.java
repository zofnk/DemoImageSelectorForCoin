 ...
 */
public class VDivideDecoration extends FlexibleDividerDecoration {

    private MarginProvider mMarginProvider;

    protected VDivideDecoration(Builder builder) {
        super(builder);
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public VDivideDecoration build() {
            checkBuilderParams();
            return new VDivideDecoration(this);
        }
    }
}